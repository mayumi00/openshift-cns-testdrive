...
[Note]
====
OpenShiftに付属するさまざまなロールに興味がある場合は、link:https://docs.openshift.com/container-platform/4.12/authentication/using-rbac.html[Role-Based
...
ここでは、`projectRequestMessage` と `Please visit https://ticket.example.com to request a project` というValueを指定しています。
